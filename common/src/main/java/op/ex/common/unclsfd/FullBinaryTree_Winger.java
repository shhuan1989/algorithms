...
public class FullBinaryTree_Winger implements Runnable {

	private PrintWriter out;
	
//	final String file = "FullBinaryTree-Large";
	final String file = ChargingChaos.class.getClassLoader().getResource("FullBinaryTree-Large.in").getPath();
	...
	public void run() {
		try {
			FastReader in = new FastReader(new BufferedReader(new FileReader(file)));
