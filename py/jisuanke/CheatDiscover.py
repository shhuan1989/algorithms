...
"""
created by huash06 at 2015-07-16 16:52

鉴于我市拥堵的交通状况，市政交管部门经过听证决定在道路两侧安置自动停车收费系统。当车辆驶入车位，系统会通过配有的摄像头拍摄车辆画面，
通过识别车牌上的数字、字母序列识别车牌，通过连接车管所车辆信息数据库确认车辆，进行扣费。
斗智斗勇的好戏一般从此处展开…
...
作为实习生的蒜头也是任务艰巨，将已经存在车辆数据库中的可与当前已知信息相匹配的车牌信息筛选出来，
这可是整个项目的第一步啊，重要性我就不多说了，加油吧。
