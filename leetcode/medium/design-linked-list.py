...
for op, param in zip(["MyLinkedList","addAtIndex","addAtIndex","addAtIndex","get"], [[],[0,10],[0,20],[1,30],[0]]):
    if op == 'MyLinkedList':
        lst = MyLinkedList()
    elif op == 'addAtHead':
        lst.addAtHead(param[0])
    elif op == 'addAtTail':
        lst.addAtTail(param[0])
    elif op == 'addAtIndex':
        lst.addAtIndex(param[0], param[1])
    elif op == 'get':
        print(lst.get(param[0]))
    elif op == 'deleteAtIndex':
        lst.deleteAtIndex(param[0])
