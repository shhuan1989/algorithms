...
public class CJ2014R1BPC{
	...
	public static void main(String[] args) {
		try {
//			System.setIn(new BufferedInputStream(new FileInputStream(args.length > 0 ? args[0] : (CJ2014R1BPC.class.getName() + ".in"))));
			System.setIn(Google_TakingMetro.class.getClassLoader().getResourceAsStream("2014r1bpc_small.in"));
			System.setOut(new PrintStream(new FileOutputStream("/Users/huash/git/Algorithms/py/google/cj2014/round1B/output/C-small-practice-j.out")));
